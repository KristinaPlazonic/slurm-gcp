...
PreemptMode=REQUEUE
PartitionName=graphical Nodes=google1-compute1 PriorityTier=40 MaxTime=1-0 OverSubscribe=FORCE:5 PreemptMode=GANG
PartitionName=main Nodes=google1-compute2 PriorityTier=40 MaxTime=1-0 PreemptMode=REQUEUE
#DisableRootJobs=NO
